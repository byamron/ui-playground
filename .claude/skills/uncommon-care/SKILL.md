---
name: uncommon-care
description: Generative craft critique. Analyzes a demo through 8 lenses (fidgetability, flow continuity, reduction, materiality, etc.) and proposes concrete next steps to elevate the craft. Use when the user wants to push a demo further, not just evaluate if it's ship-ready.
---
